...
function getSchemaForContentType({
    ...
    contentType: string;
    media: Record<string, OpenAPIV3_1.MediaTypeObject>;
}): OpenAPIV3_1.ReferenceObject | OpenAPIV3_1.SchemaObject | undefined {
    return media[contentType]?.schema;
}

function multipartRequestHasFile(
    multipartSchema: OpenAPIV3_1.ReferenceObject | OpenAPIV3_1.SchemaObject,
...
function resolveSchema(schema: OpenAPIV3_1.ReferenceObject, document: OpenAPIV3_1.Document): ResolvedSchema {
