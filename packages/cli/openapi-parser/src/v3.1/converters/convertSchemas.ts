        ...
        if (firstElement === "null") {
            return Schema.nullable({
                value: convertSchemaObject(
                    {
                        ...schema,
                        type: secondElement as OpenAPIV3_1.NonArraySchemaObjectType,
                    },
                    wrapAsNullable,
                    context,
                    breadcrumbs,
            ...
            return Schema.nullable({
                value: convertSchemaObject(
                    {
                        ...schema,
                        type: firstElement as OpenAPIV3_1.NonArraySchemaObjectType,
                    },
                    wrapAsNullable,
                    context,
                    breadcrumbs,
...
export function getSchemaIdFromReference(ref: OpenAPIV3_1.ReferenceObject): string {
...
function hasNoOneOf(schema: OpenAPIV3_1.SchemaObject): boolean {
    return schema.oneOf == null || schema.oneOf.length === 0;
}

function hasNoAllOf(schema: OpenAPIV3_1.SchemaObject): boolean {
    return schema.allOf == null || schema.allOf.length === 0;
}

function hasNoProperties(schema: OpenAPIV3_1.SchemaObject): boolean {
...
function getSingularAllOf({
    ...
    allOf: (OpenAPIV3_1.ReferenceObject | OpenAPIV3_1.SchemaObject)[];
...
function isAllOfElementEmpty(schema: OpenAPIV3_1.ReferenceObject | OpenAPIV3_1.SchemaObject): boolean {
...
function getMaybeAllEnumValues({
    ...
    schemas: (OpenAPIV3_1.ReferenceObject | OpenAPIV3_1.SchemaObject)[];
}): undefined | string[] {
