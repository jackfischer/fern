...
function convertSyncAndAsyncEndpoints({
    ...
    operation: OpenAPIV3_1.OperationObject;
    pathItemParameters: (OpenAPIV3_1.ReferenceObject | OpenAPIV3_1.ParameterObject)[] | undefined;
    document: OpenAPIV3_1.Document;
    context: AbstractOpenAPIV3_1ParserContext;
}): Endpoint[] {
...
function getSdkName({ operation }: { operation: OpenAPIV3_1.OperationObject }): EndpointSdkName | undefined {
...
function isEndpointAuthed(operation: OpenAPIV3_1.OperationObject, document: OpenAPIV3_1.Document): boolean {
