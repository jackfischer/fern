...
export function convertSecurityScheme(
    securityScheme: OpenAPIV3_1.SecuritySchemeObject | OpenAPIV3_1.ReferenceObject
...
function convertSecuritySchemeHelper(securityScheme: OpenAPIV3_1.SecuritySchemeObject): SecurityScheme | undefined {
